...
\begin{eqnarray*}
    \widehat{\mathcal{X}} =
    \arg \underset{ \mathcal{X} \in \mathbb{R}^{N_1 \times N_2 \times N_3}} \min \ \| \mathbf{y} - \mathcal{H}(\mathcal{X}) \|_F^2 , \\
...
\begin{eqnarray*}
    \widehat{\mathcal{X}} =
    \arg \underset{ \mathcal{U} \in \mathbb{R}^{N_1 \times r \times N_3}, \mathcal{V} \in \mathbb{R}^{r \times N_2 \times N_3}} \min \ \| \mathbf{y} - \mathcal{H}(\mathcal{U} \bullet \mathcal{V}) \|_F^2 , \\
\end{eqnarray*}
...
For simplicity, we use $\mathcal{A}^c$ to represent the cicular matrixof tensor $\mathcal{A}$.Then the $\mathcal{L}$-product $\mathcal{$X} = \mathcal{U} \bullet \mathcal{V}$ has an equivalent matrix-product as:
\begin{equation}
...
\begin{eqnarray*}
    \widehat{\mathbf{V}}^c =
    \arg \underset{ \mathbf{V} \in \mathbb{R}^{rN_3 \times N_2N_3}} \min \ \| \mathbf{y} - \mathcal{H}(\mathbf{U}^c\mathbf{V}^c) \|_F^2 , \\
\end{eqnarray*}
...
\begin{eqnarray*}
    \widehat{\mathbf{U}}^c =
    \arg \underset{ \mathbf{U} \in \mathbb{R}^{rN_3 \times N_2N_3}} \min \ \| \mathbf{y} - \mathcal{H}(\mathbf{U}^c\mathbf{V}^c) \|_F^2 . \\
\end{eqnarray*}
...
\item Stack all the columns of $\mathbf{V}^c$, and then $\mathbf{V}^c$ is vectorized to a vector $\mathbf{b}$ of size $rN_2N_3N^2_3 \times 1$ as follows:
    \begin{eqnarray*}
        ...
        =[\mathbf{V}^c(:,1)^T, \mathbf{V}^c(:,2)^T, \dots, \mathbf{V}^c(:,N_2N_3)^T]^T.
    \end{eqnarray*}
...
\item Each $\mathbf{A}^c_m$, $1 \leq m \leq M$ is represented as a vector $\mathbf{c}_m$ of size $N_1N_2N^2_3 \times 1$ in the following way:
    ...
    \[
        \begin{eqnarray*}
            \widehat{\mathbf{b}}^c =
            \arg \underset{ \mathbf{b} \in \mathbb{R}^{rN_2N^2_3 \times 1}} \min \ \| \mathbf{y} - \mathbf{B}_2\mathbf{B}_1b) \|_F^2 , \\
        \end{eqnarray*}
    \]
